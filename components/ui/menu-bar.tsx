...
type MotionNavProps = Omit<React.ComponentProps<typeof motion.nav>, 'children'>

interface MenuBarProps extends MotionNavProps {
  items: MenuItem[]
  activeItem?: string
...
const sharedTransition = { duration: 0.5 }
